...
## Requirements to run a validator on Sui {#requirements-validator}
...
## Validator consensus and voting power {#validator-consensus-voting-power}
...
### User staking and withdrawals {#user-staking-withdrawals}
...
### Find the exchange rate {#find-exchange-rate}
...
### User staking and rewards {#user-staking-rewards}
...
## Validator slashing and tallying rule {#validator-slashing-tallying}
