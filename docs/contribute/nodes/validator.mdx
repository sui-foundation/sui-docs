...
## Requirements to run a validator on Sui {#requirements-to-run-a-validator-on-sui}
...
### Validator staking pool requirements {#validator-staking-pool-requirements}
...
## Validator consensus and voting power {#validator-consensus-and-voting-power}
...
## Validator staking pool {#validator-staking-pool}
...
### User staking and withdrawals {#user-staking-and-withdrawals}
...
### Find the exchange rate {#find-the-exchange-rate}
...
### User staking and rewards {#user-staking-and-rewards}
...
## Reference gas price {#reference-gas-price}
...
## Validator slashing and tallying rule {#validator-slashing-and-tallying-rule}
