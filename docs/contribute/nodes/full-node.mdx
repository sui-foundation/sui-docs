...
## Configure a Full node {#configure-a-full-node}
...
1.  Start the Sui Full node:
    ...
    ```
1.  Optional: [Publish/subscribe](../../learn/core-concepts/event-query-and-subscription.mdx#subscribe-events) to notifications using JSON-RPC via websocket.
