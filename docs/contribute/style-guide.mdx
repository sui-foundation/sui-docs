...
### Optimize for discoverability {#optimize-for-discoverability}
...
### Keyboard keys in procedures {#keyboard-keys-in-procedures}
...
## New section template (Heading 2) {#new-section-template-heading-2}

Describe the section.

### Subsection or category (Heading 3) {#subsection-or-category-heading-3}
