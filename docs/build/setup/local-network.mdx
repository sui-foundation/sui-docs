...
### Install Sui locally {#install-sui-locally}
...
### Install Sui from GitHub {#install-sui-from-github}
...
## Show the current active address {#show-the-current-active-address}
...
### Check the gas coin objects for the active address {#check-the-gas-coin-objects-for-the-active-address}
...
## Install Sui Wallet and Sui Explorer locally {#install-sui-wallet-and-sui-explorer-locally}
...
### Set up Sui Explorer on your local network {#set-up-sui-explorer-on-your-local-network}
...
## Set up a local Sui Wallet {#set-up-a-local-sui-wallet}
...
### Add local Sui Wallet to Chrome {#add-local-sui-wallet-to-chrome}
...
## Test with the Sui TypeScript SDK {#test-with-the-sui-typescript-sdk}
