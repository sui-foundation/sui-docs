...
### An example Sui Hero module {#an-example-sui-hero-module}
...
## Work with Object Display {#work-with-object-display}
...
## Sui utility objects {#sui-utility-objects}
...
## Typical objects with data duplication {#typical-objects-with-data-duplication}
...
## Unique objects with dynamic representation {#unique-objects-with-dynamic-representation}
...
## Objects with unique static content {#objects-with-unique-static-content}
