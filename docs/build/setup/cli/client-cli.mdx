...
### Paying For transactions with gas objects {#paying-for-transactions-with-gas-objects}
...
## Create new account addresses {#create-new-account-addresses}
...
### Create a new account address {#create-a-new-account-address}
...
### Add existing accounts to client.yaml {#add-existing-accounts-to-clientyaml}
...
## Merge and split coin objects {#merge-and-split-coin-objects}
