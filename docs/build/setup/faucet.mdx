...
## 1. Request test tokens through Discord {#1-request-discord}
...
## 2. Request test tokens through wallet {#2-request-wallet}
...
## 3. Request test tokens through cURL {#3-request-curl}
...
## 4. Request test tokens through TypeScript SDK {#4-request-typescript-sdk}
