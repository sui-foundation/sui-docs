...
## 1. Request test tokens through Discord {#1-request-test-tokens-through-discord}
...
## 2. Request test tokens through wallet {#2-request-test-tokens-through-wallet}
...
## 3. Request test tokens through cURL {#3-request-test-tokens-through-curl}
...
## 4. Request test tokens through TypeScript SDK {#4-request-test-tokens-through-typescript-sdk}
