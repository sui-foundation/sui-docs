...
## Transaction Input: GasData {#transaction-input-gasdata}
...
## Budget Consumption {#budget-consumption}
...
## Transaction Output: GasCostSummary {#transaction-output-gascostsummary}
...
## Out Of Gas Model {#out-of-gas-model}
