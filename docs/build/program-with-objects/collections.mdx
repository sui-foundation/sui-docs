...
### Interacting with Collections {#interacting-with-collections}
...
### Querying Length {#querying-length}
...
### Querying for Containment {#querying-for-containment}
...
### :warning: Equality {#warning-equality}
