---
title: Create a Coin in Sui Move
sidebar_label: Create a Coin
slug: /create-a-coin
---

Publishing a coin is Sui is almost as simple as publishing a new type. However it is a bit tricky as it requires using a [One Time Witness](otw-example).
