...
## Requirements to configure a SUI integration {#requirements-to-configure-a-sui-integration}
...
## Configure a Sui Full node {#configure-a-sui-full-node}

You can set up and configure a Sui Full node using Docker or directly from source code in the Sui GitHub repository.

### Install a Sui Full node using Docker {#install-a-sui-full-node-using-docker}
...
## Install a Sui Full node from source {#install-a-sui-full-node-from-source}
...
## Set up Sui addresses {#set-up-sui-addresses}
...
## Track balance changes for an address {#track-balance-changes-for-an-address}
...
## Use events to track balance changes for an address {#use-events-to-track-balance-changes-for-an-address}
...
## Sui API operations for transfers {#sui-api-operations-for-transfers}
