...
### Smart contracts define asset types and their logic {#smart-contracts-define-asset-types-and-their-logic}
...
### Censorship-resistance and openness {#censorship-resistance-and-openness}
