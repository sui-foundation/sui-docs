...
:::tip
The WebSocket client supports only [subscription](reference/event-query-and-subscription.mdx#subscribe-events); use the HTTP client for other API methods.
:::
...
Use the WebSocket client to [subscribe to events](../event-query-and-subscription.mdx#subscribe-events).
