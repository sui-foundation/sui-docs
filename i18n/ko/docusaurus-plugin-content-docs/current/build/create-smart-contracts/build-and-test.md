...
If you execute this command for the package created in [write a package](write-move-packages.md), you see the following output. Unsurprisingly, the test result has an `OK` status because there are no tests written yet to fail.
