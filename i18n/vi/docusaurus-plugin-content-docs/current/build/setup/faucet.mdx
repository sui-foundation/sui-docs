...
## 1.  Request test tokens through Discord {#request-discord}
...
## 2.  Request test tokens through wallet {#request-wallet}
...
## 3.  Request test tokens through cURL {#request-curl}
...
## 4.  Request test tokens through TypeScript SDK {#request-typescript-sdk}
