...
### An example Sui Hero module {#sui-hero-module}
...
## Typical objects with data duplication {#objects-data-duplication}
...
## Unique objects with dynamic representation {#dynamic-representation}
...
## Objects with unique static content {#unique-static-content}
