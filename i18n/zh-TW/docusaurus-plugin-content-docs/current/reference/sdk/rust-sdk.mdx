...
Use the [`SuiClient`](../../build/setup/cli/client-cli.mdx) to create an HTTP or a WebSocket client (`SuiClient::new`). See the [JSON-RPC](../json-rpc/read-api.mdx) documentation for the list of available methods.
