...
-   Transactions take objects as input and produce objects as output—check out the [objects](../../learn/core-concepts/objects.mdx) section to learn more about the structure and attributes of objects.
-   Sui supports several different transaction types—see the [transactions](../../learn/core-concepts/transactions.mdx) section for full details.
