---
title: Transferring Objects in Sui Move
sidebar_label: Transferring Objects
slug: /transferring-objects
---

To make an object freely transferable, use a combination of the `key` and `store` abilities.
