...
2.  Install [Sui binaries](#install-sui-binaries).
3.  Configure an [Integrated Development Environment (IDE)](#integrated-development-environment).
4.  Request [SUI test tokens](#sui-tokens) to use on Sui Devnet or Sui Testnet networks.
...
## Documentation in the Sui repository {#documentation}
